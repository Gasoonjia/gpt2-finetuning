...
from lm_dataset import load_lm_dataset
...
from transformers import (
    ...
    default_data_collator, # data collator for our lm
)
...
def main():
    ...
    if (model_args.tuning_mode != 'prefixtune') and ('lowdata' not in training_args.output_dir) and (model_args.tuning_mode != 'adaptertune'):
        ...
        ## in here
        print(model_args.tuning_mode) # prefixtune
    ...
    if model_args.tuning_mode == 'prefixtune': # prefixtune
        ...
        print('loading the prefix model from ', model_args.prefixModel_name_or_path) # model_args.prefixModel_name_or_path = None
